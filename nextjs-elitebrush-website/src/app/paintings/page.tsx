...
// Query to fetch all painting content
        ...
        <div className="container mx-auto px-6 md:px-10">
          <div className="max-w-7xl mx-auto w-full">
            ...
            <p className="text-xl text-white/80 max-w-3xl">
              See the dramatic difference our painting services make with these before and after comparisons.
            </p>
          </div>
        </div>
      </section>
    ...
    {paintingsWithSliders.length > 0 ? (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
        {paintingsWithSliders.map((painting) => (
          <div key={painting._id} className="bg-black/20 p-6 rounded-xl shadow-lg">
            <h3 className="text-2xl font-bold text-white text-center mb-6">{painting.title || "See The Difference"}</h3>
            <BeforeAfterSlider
